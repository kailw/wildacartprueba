    ...
    function ($scope, toolService, $http, sessionService, $routeParams, $location) {
        ...
        $scope.pdf = function (id, fecha, iva) {
            ...
            $http({
                ...
                doc.setFontSize(15);
                doc.setFontType('bold');
                doc.text(12, 95, 'Codigo');
                doc.text(50, 95, 'Descripcion');
                ...
                for (var i = 0; i < $scope.ajaxDatoLineaFactura.length; i++) {
                    ...
                    doc.text(50, linea, $scope.productoDesc);
                    doc.text(125, linea, $scope.productoCantidad.toString());
                    doc.text(129, linea, " x " + $scope.productoPrecioUno.toFixed(2));
                ...
                $scope.precioTotal = $scope.productoPrecioTotal * iva / 100;

                doc.text(170, 279, $scope.precioTotal.toFixed(2).toString());
                doc.save("facturasDelUsuario" + $scope.ajaxDatosUsuarios.id + ".pdf");
